...
library("ggplot2")
mergeDataframe$numMurders <- int(mergeDataframe$population*mergeDataframe$Murder/100000)
...
barChart2 <- ggplot(mergeDataframe, aes(x=stateName, y=numMurders, ggtitle="Total Murders"))
